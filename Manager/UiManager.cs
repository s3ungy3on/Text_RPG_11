...
namespace Text_RPG_11
{
    ...
    public class UIManager
    {
        ...
        private string SkipMessage="아무키를 눌러 SKIP"; // 스토리 스킵 문구
        ...
        {
            SafeResize(240, 68);
            string Skip = SkipMessage.PadLeft(55);
            string name = "";
            string act = "";
            ...
            story.Add("System: 플레이어들이 게임에 접속하지 않았습니다."); // [18]
            story.Add("System:  60초 내에 /다시하기를 입력하여 게임을 재시작 할 수 있습니다."); //[19]
            story.Add("변대섭: 아 시간만 버렸네 다시하기 gg"); // [20]
            story.Add("System: 게임을 재시작합니다"); // [21]
            story.Add("System: 챔피언 구성 중....");
            story.Add("System: 미니언 구성 중...."); // [23]
            story.Add("삐------삐-------"); // [24]
            story.Add("System: 에러 발생 소환사를 불러옵니다"); // [25]
            story.Add("변대섭: 이게 뭔 말이......으아아아아아아"); // [26]
            story.Add("............................................................"); // [27]
            story.Add("............................................................"); // [28]
            story.Add("???: 영웅은 죽지 않아요"); // 메르시 아트 출력 [29]
            story.Add("변대섭: 으...으윽...머리야..."); // [30]
            story.Add("???: 드디어 일어나셨군요"); // [31]
            story.Add("변대섭: 으..어???? 아니 당신은 메르시 아닌가요?"); // [32]
            story.Add("소라카: 네?? 저는 소라카 입니다만...."); // 소라카 아트 출력 [33]
            story.Add("변대섭: 아 그렇군요"); // [34]
            story.Add("변대섭: 근데 제가 왜 여기 있는거죠??"); // [35]
            story.Add("소라카: 지금 현재 미니언과 중립몹 즉 정글과 용 바론 등이 손을 잡고 반란을 일으켰습니다"); // [36]
            story.Add("소라카: 그래서 게임 시스템이 비상사태를 인지하고 소환사님을 부른겁니다.");
            story.Add("소라카: 아마 들어오기 전에 문구가 있었을텐데 못 보셨을까요??"); // [38]
            story.Add("변대섭: (아 들어오기 전에 처음 본 문구가 그건가 보네)"); // [39]
            story.Add("변대섭: 본거 같아요");
            story.Add("변대섭: 그래서 제가 뭘 하면 되는거죠"); // [41]
            story.Add("소라카: 소환사님은 여기서 직접 챔피언을 골라 플레이 하시면서 반란을 일으킨 몹들을 잡으시면 됩니다"); // [42]
            story.Add("변대섭: (뭐야 롤 현실판 아니야? 이거 완전 개꿀 체험이자나)"); // [43]
            story.Add("변대섭: 그런거라면 맡겨만 주세요 제가 다 해결하겠습니다");
            story.Add("변대섭: 어디보자 골드가....??????"); // [45]
            story.Add("소라카: 아 이걸 말을 안 해줬네요"); // [46]
            story.Add("소라카: 지금 시스템 에러때문에 싸우시고 직접 얻으셔야 합니다.");
            story.Add("소라카: 시간이 지나도 돈은 들어오지 않으니 몹들을 잡으셔야 돈과 아이템을 얻을 수 있습니다."); // [48]
            story.Add("변대섭: 아니 그럼 어떻게 해요 원래 게임도 500G는 주고 하는데"); // [49]
            story.Add("소라카: 대신 시스템에서 퀘스트를 받을 수 있습니다."); // [50]
            story.Add("소라카: 퀘스트를 완료할 시 골드와 경험치 아이템을 얻을 수 있는데 그래도 힘드실까요?");
            story.Add("소라카: 그게 아니면 혹시 쫄리신건가요? 쫄?"); // [52]
            story.Add("변대섭: 쫄긴 누가 쫄았다고 그래요 바로 갔다 오겠습니다."); // 이후로 2차제목과 소제목 등장 [53]
        ...
        private void HandleEquipItem()
        {
            ...
            Console.Clear();
            PrintColoredLine("==================================== [ 장착 가능한 아이템 ] ====================================", ConsoleColor.Cyan);
        ...
        public void ShowShop()
        {
            ...
            for (int i = 0; i < shopItems.Count; i++)
            {
                ...
                if (i > 1)
                {
                    if (item.Rarity != shopItems[i - 1].Rarity)
                    {
                        Console.ForegroundColor = ConsoleColor.Cyan;
                        WriteLineDivider('-', 120);
                    }
                }
                SetRarityColor(item.Rarity);
            ...
            PrintColoredLine("========================================================================================================================", ConsoleColor.Yellow);
        ...
        private void HandleShopPurchase(Shop shop)
        {
            ...
            foreach (var item in items)
            {
                ...
                {
                    if (item.Rarity != items[items.IndexOf(item) - 1].Rarity)
                    {
                        Console.ForegroundColor = ConsoleColor.Cyan;
                        WriteLineDivider('-', 120);
                    }
                ...
                SetRarityColor(item.Rarity);
                Console.WriteLine($"{items.IndexOf(item)+1}. {gameManager.messages.PaddingKorean_Right(item.Name, 20)} |" +
                    $"{gameManager.messages.PaddingKorean_Right(item.ItemType(), 10)} |" +
                    $"{gameManager.messages.PaddingKorean_Right(item.ItemStats(), 50)} |" +
                    $"{gameManager.messages.PaddingKorean_Right(item.Rarity, 10)} | {item.Price}G");
                Console.ResetColor();
        ...
        private void HandleShopSell(Shop shop)
        {
            ...
            Console.Clear();
            PrintColoredLine("========================= [ 판매 목록 ] =========================", ConsoleColor.Cyan);
